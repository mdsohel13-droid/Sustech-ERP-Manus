...
export function CommandBar({ open, onClose }: CommandBarProps) {
  ...
  const navigationItems: CommandItem[] = useMemo(() => [
    ...
    { id: "nav-contacts", label: "Contacts", icon: Users, action: () => setLocation("/customers"), category: "navigation", keywords: ["contacts", "customers", "clients"] },
    ...
    { id: "nav-crm", label: "CRM", icon: Target, action: () => setLocation("/action-tracker"), category: "navigation", keywords: ["crm", "leads", "opportunities"] },
